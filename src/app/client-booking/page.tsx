  ...
  return (
    <div className='min-h-screen bg-[#F3F4F6]'>
      ...
      <div className='container mx-auto mt-6'>
        ...
        <main className='py-4 sm:py-6'>
          {isLoading ? (
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 p-6 sm:p-0'>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className='max-w-2xl max-h-[90vh] overflow-y-auto p-0 [&>button:last-child]:hidden'>
          {selectedBooking && (
            <>
              {/* Modal Header */}
