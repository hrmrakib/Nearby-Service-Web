...
export default function CommentsSection2({
  ...
  const [createCommentMutation, { isLoading: isCommentLoading }] =
    useCreateCommentMutation();
        ...
        <div className='mb-5'>
          ...
          <div className='flex gap-2'>
            ...
            <button
              ...
              className='px-5 py-2.5 bg-green-500 hover:bg-green-600 text-white text-sm font-semibold rounded-lg transition-colors active:scale-95 flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed'
            >
              Post
            </button>
          </div>
